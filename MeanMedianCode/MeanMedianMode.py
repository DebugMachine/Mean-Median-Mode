...
def get_mode(sorted_data):
    #Calculating Mode of the given data in the csv file
...
with open('C:/Users/aryan/Desktop/coding/Coding (Phython)/MeanMedianCode/SOCR-HeightWeight.csv.csv',) as f:
    reader = csv.reader(f)
